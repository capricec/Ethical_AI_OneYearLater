...
import { computeStatementsViz } from '$lib/data/computeStatementsViz.js';
...
function firstGlobalItemId() {
	const viz = computeStatementsViz(encoding, compiled, null);
...
export const statementsViz = derived([rawDataset, selectedDimensionFilter], ([$raw, $filter]) =>
	computeStatementsViz($raw.encoding, $raw.compiled, $filter)
);
