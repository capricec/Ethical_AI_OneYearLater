...
export const METHODOLOGY_PARAGRAPHS = [
	"I reconfigured the survey to be answerable by a chat interface and wrote a script that asked and recorded the models answers to these questions daily. Some parts of the survey weren't applicable to an AI model, so it isn't a true 1:1 replication.",
